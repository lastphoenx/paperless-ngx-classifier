...
2. **Paperless Branding** → `PAPERLESS_APP_TITLE` + optional Logo in `media/logo/`.
3. **Dashboard statt Welcome-Widget** → Nutzer kann Widget wegklicken (X); stattdessen **Saved View** «Offene Rechnungen» o.ä. auf Dashboard pinnen.
4. **Doku-Link** → Gespeicherte Ansicht oder Lesezeichen; kein eingebauter Custom-Text im Welcome-Widget.
