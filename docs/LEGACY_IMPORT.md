...
Wenn ein **einzelnes Paperless-Dokument** viele Legacy-Einzeldokumente enthält (QR auf jeder Trennseite, z. B. `060102_Gesundheit_PersonB`), aber **nicht** beim Bulk-Import gesplittet wurde:
