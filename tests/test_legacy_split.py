...
def test_match_barcode_embedded():
    ...
    assert _match_barcode("060102_Gesundheit_PersonB", pat) == "060102_Gesundheit_PersonB"
    assert _match_barcode("prefix 010401_Lohn_PersonB suffix", pat) == "010401_Lohn_PersonB"
...
def test_match_barcode_space_format():
    ...
    assert _match_barcode("060101 Gesundheit PersonA", pat) == "060101 Gesundheit PersonA"
    assert _match_barcode("020101 Rg allgemein", pat) == "020101 Rg allgemein"
    multiline = "SPC\n0200\n060101 Gesundheit PersonA\nCH"
    assert _match_barcode(multiline, pat) == "060101 Gesundheit PersonA"
